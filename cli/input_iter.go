...
type guessedInputIter struct {
	t *time.Time
}

func newGuessedInputIter(t time.Time) inputIter {
	return &guessedInputIter{
		t: &t,
	}
}

func (i *guessedInputIter) Next() (interface{}, bool) {
	if i.t != nil {
		t := i.t
		i.t = nil
		return encap(*t), true
...
func (i *guessedInputIter) Close() error {
	i.t = nil
	return nil
}

func (i *guessedInputIter) Name() string {
	return "<guessed>"
}
